...
void main() {
  ...
  group('Comprehensive Unit Test: Modul Keranjang (Cart) & Checkout', () {
    ...
    test('1. Ritel menambahkan produk ke dalam keranjang untuk pertama kali', () {
    ...
    test('2. Ritel menambahkan produk saat stok produk dibawah MOQ (Harus tetap bisa tambah seadanya stok)', () {
    ...
    test('3. Validasi field kuantitas hanya bisa via increment/decrement (Tidak ada set manual)', () {
       // Unit test ini memverifikasi bahwa kita menggunakan metode terukur
       cartController.addToCart(id: 'p3', title: 'P3', variant: 'V', price: 10, imageUrl: 'i', minOrder: 1, stockLimit: 10, quantity: 1, category: 'C');
    ...
    test('4. Menambah jumlah produk dengan tombol (+)', () {
      cartController.addToCart(id: 'p1', title: 'P1', variant: 'V', price: 1000, imageUrl: 'i', minOrder: 1, stockLimit: 10, quantity: 1, category: 'C');
    ...
    test('5. Menambah jumlah produk hingga melebihi sisa stok (Harus tertahan di stockLimit)', () {
      cartController.addToCart(id: 'p1', title: 'P1', variant: 'V', price: 1000, imageUrl: 'i', minOrder: 1, stockLimit: 3, quantity: 2, category: 'C');
    ...
    test('6. Mengurangi jumlah produk dengan tombol (-)', () {
      cartController.addToCart(id: 'p1', title: 'P1', variant: 'V', price: 1000, imageUrl: 'i', minOrder: 1, stockLimit: 10, quantity: 5, category: 'C');
    ...
    test('7. Mengurangi jumlah produk pada batas bawah MOQ (Harus tertahan di minOrder)', () {
      cartController.addToCart(id: 'p1', title: 'P1', variant: 'V', price: 1000, imageUrl: 'i', minOrder: 5, stockLimit: 10, quantity: 6, category: 'C');
    ...
    test('12. Menambahkan produk yang sudah ada didalam keranjang', () {
      cartController.addToCart(id: 'p1', title: 'P1', variant: 'V', price: 1000, imageUrl: 'i', minOrder: 1, stockLimit: 10, quantity: 2, category: 'C');
      cartController.addToCart(id: 'p1', title: 'P1', variant: 'V', price: 1000, imageUrl: 'i', minOrder: 1, stockLimit: 10, quantity: 3, category: 'C');
    ...
    test('13. Menambahkan beberapa jenis produk', () {
      cartController.addToCart(id: 'p1', title: 'P1', variant: 'V', price: 1000, imageUrl: 'i', minOrder: 1, stockLimit: 10, quantity: 1, category: 'C');
      cartController.addToCart(id: 'p2', title: 'P2', variant: 'V', price: 2000, imageUrl: 'i', minOrder: 1, stockLimit: 10, quantity: 1, category: 'C');
    ...
    test('11. Persistensi data keranjang (Save/Load)', () async {
      cartController.addToCart(id: 'persist', title: 'P', variant: 'V', price: 100, imageUrl: 'i', minOrder: 1, stockLimit: 10, quantity: 2, category: 'C');
